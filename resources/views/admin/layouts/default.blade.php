@php
$cur_tenant_id = auth()->user()->tenant_id;
...
<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
    ...
    <div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
        ...
        <a href="#" class="brand-logo">
            ...
            @else
            <img src="{{ asset('img/client/vineconnect_logo_white.png') }}" style="width:100%;" alt="ServusCafe Logo">
            @endif
        </a>
        <!--end::Logo-->
        <!--begin::Toolbar-->
                        ...
                        <div class="header-menu-wrapper header-menu-wrapper-left" id="kt_header_menu_wrapper">
                            <div id="kt_header_menu" class="header-menu header-menu-mobile header-menu-layout-default">
                                <ul class="menu-nav">
									...
									<li class="menu-item menu-item-submenu menu-item-rel" aria-haspopup="true">
                                        <a href="{{url('/admin/profile')}}" class="menu-link text-dark">
                                    ...
                                    <li class="menu-item menu-item-submenu menu-item-rel" aria-haspopup="true">
                                        <a class="log-out-btn menu-item text-dark" href="#" onclick="event.preventDefault();document.getElementById('logout-form').submit();"> Logout </a>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-check col-md-12 p-0">
                        <p>This Services Agreement for Servus Cafe Client Portal SaaS Product (the "Agreement") is made and entered into by and between you ("Client"), and Goldenfarb Copeland FV Software Ventures, LLC d/b/a “Vinetegrate”, a Florida corporation having its principal place of business at 275 Toney Penna Dr. Suite 8, Jupiter, FL 33458 ("Vinetegrate"), collectively referred to as the "Parties."</p>
                        <h5>RECITALS</h5>
                        <p>WHEREAS, Vinetegrate has developed and owns a software-as-a-service (SaaS) product called "Servus Cafe Client Portal" (the "Product");</p>
