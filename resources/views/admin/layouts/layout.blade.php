...
<body id="kt_body" class="header-mobile-fixed subheader-enabled aside-enabled aside-fixed aside-secondary-enabled page-loading">
	...
	<div id="kt_header_mobile" class="header-mobile">
		<!--begin::Logo-->
		<a href="index.html">
			<img alt="Logo" src="/media/logos/logo-letter-2.png" class="logo-default max-h-30px" />
		</a>
		<!--end::Logo-->
		<!--begin::Toolbar-->
			...
			<div class="aside aside-left d-flex aside-fixed" id="kt_aside">
				...
				<div class="aside-primary d-flex flex-column align-items-center flex-row-auto">
					...
					<div class="aside-brand d-flex flex-column align-items-center flex-column-auto py-5 py-lg-12">
						<!--begin::Logo-->
						<a href="{{url('/admin')}}">
							<img alt="Logo" src="/assets/img/client/logo1.png" class="max-h-50px" />
						</a>
						<!--end::Logo-->
					</div>
					<!--end::Brand-->
					...
					<div class="aside-workspace scroll scroll-push my-2">
						...
						<div class="tab-content">
							...
							<div class="tab-pane p-3 px-lg-7 py-lg-5 fade show active" id="kt_aside_tab_1">
								<div class="aside-brand d-flex flex-column flex-column-auto py-5 py-lg-12">
									<!--begin::Logo-->
									<a href="{{url('/admin')}}">
										<img alt="Logo" src="/assets/img/client/logo1.png" style="max-height: 100px !important;" class="max-h-30px" />
									</a>
									<!--end::Logo-->
								</div>
										...
										<div class="d-flex align-items-center">
											...
											<div class="symbol symbol-40 symbol-light mr-4">
												<span class="symbol-label bg-hover-white">
													<img src="media/svg/misc/006-plurk.svg" class="h-50 align-self-center" />
												</span>
											</div>
											<!--end::Symbol-->
											<!--begin::Text-->
											<div class="d-flex flex-column flex-grow-1 mr-2">
												<span class="text-dark-75 font-size-h6 mb-0">Order</span>
												<a href="{{url('/order-list')}}" class="text-muted text-hover-primary font-weight-bold">Order list</a>
											</div>
											<!--begin::End-->
										</div>
									</div>
																	...
																	<tbody>
																			...
																			<td class="pl-0">
																				<div class="symbol symbol-50 symbol-light mr-2 mt-2">
																					<span class="symbol-label">
																						<img src="/media/svg/avatars/018-girl-9.svg" class="h-75 align-self-end" alt="" />
																					</span>
																				</div>
																			</td>
																			<td class="pl-0">
																			...
																			<td class="text-right pr-0">
																				<a href="#" class="btn btn-icon btn-light btn-sm">
																					<span class="svg-icon svg-icon-md svg-icon-success">
																						<!--begin::Svg Icon | path:/media/svg/icons/Navigation/Arrow-right.svg-->
																						<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
																							<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
																								<polygon points="0 0 24 0 24 24 0 24" />
																		...
																		<tr>
																			<td class="pl-0">
																				<div class="symbol symbol-50 symbol-light mr-2 mt-2">
																					<span class="symbol-label">
																						<img src="/media/svg/avatars/047-girl-25.svg" class="h-75 align-self-end" alt="" />
																					</span>
																				</div>
																			</td>
																			<td class="pl-0">
																		...
																		<tr>
																			<td class="pl-0">
																				<div class="symbol symbol-50 symbol-light mr-2 mt-2">
																					<span class="symbol-label">
																						<img src="/media/svg/avatars/043-boy-18.svg" class="h-75 align-self-end" alt="" />
																					</span>
																				</div>
																			</td>
																			<td class="pl-0">
											...
											<div class="card card-custom gutter-b card-stretch">
												...
												<div class="card-body pt-2">
													...
													<div class="d-flex flex-wrap align-items-center mb-10">
														<!--begin::Symbol-->
														<div class="symbol symbol-60 symbol-2by3 flex-shrink-0 mr-4">
															<div class="symbol-label" style="background-image: url('/media/stock-600x400/img-9.jpg')"></div>
														</div>
														<!--end::Symbol-->
														<!--begin::Title-->
														<div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pr-3">
													...
													<div class="d-flex flex-wrap align-items-center">
														<!--begin::Symbol-->
														<div class="symbol symbol-60 symbol-2by3 flex-shrink-0 mr-4">
															<div class="symbol-label" style="background-image: url('/media/stock-600x400/img-12.jpg')"></div>
														</div>
														<!--end::Symbol-->
														<!--begin::Title-->
														<div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pr-3">
	...
	@include('includes.quick-action-panel')
	<!--end::Quick Actions Panel-->
	<!-- begin::User Panel-->
	@include('includes.quick-user-panel')
	<!-- end::User Panel-->
	<!--begin::Quick Panel-->
	@include('includes.quick-panel')
	<!--end::Quick Panel-->
	<!--begin::Chat Panel-->
	@include('includes.quick-chat-panel')
	<!--end::Chat Panel-->
