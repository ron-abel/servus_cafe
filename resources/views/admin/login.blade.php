...
@section('title', 'Servus cafe - Admin Login Credentials Required')
...
<div class="main-container">
    <div class="container-login100">
        <div class="wrap-login100">
            <div class="logo ">
                <a href="#">
                    <img src="{{ asset('img/client/whitelogo2.svg') }}" style="width:100%;max-height:100px;"  alt="Servus Cafe Logo">
                </a>
            </div>
