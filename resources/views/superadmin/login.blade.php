...
@section('title', 'ServusCafe - Super Admin Login Credentials Required')
...
<div class="main-container">
    <div class="container-login">
        <div class="wrap-login">
            <div class="logo">
                <a href="#">
                    <img src="{{ asset('img/client/logo1.png') }}" style="width:100%;max-height:100px;"  alt="ServusCafe Logo">
                </a>
            </div>
