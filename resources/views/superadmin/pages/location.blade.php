...
<div class="main-content container">
    <div class=" card card-custom mt-6">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            <div class="">
                <h3 class="card-label">Pickup Times</h3>
            ...
            <table class="table table-bordered table-hover" id="superadmin_tenant_datatable">
                <thead>
                    <tr>
                        ...
                        <th title="Field #3">Pikup Time Note</th>
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{ $single_location->id }}</td>
                        <td>{{ $single_location->tenant->tenant_name }}</td>
                        <td>{{ $single_location->name }}</td>
                        <td>
                        {{ $single_location->note }}
                        </td>
                    </tr>
                    @endforeach
                </tbody>
